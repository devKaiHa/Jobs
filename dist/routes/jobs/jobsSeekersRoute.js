...
const { getJobUser, updateJobUser, deleteJobUser, getJobUsers, } = require("../../services/jobs/jobSeekersService");
const { uploadJobSeekerFiles, processJobSeekerFiles, } = require("../../services/jobSeekersAuthService");
...
jobsUsersRoute
    .route("/:id")
    .get(getJobUser)
    .put(authService.protect, uploadJobSeekerFiles, processJobSeekerFiles, updateJobUser)
